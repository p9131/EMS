...
/////////////////////////////////////////////////////New Scene1( view all employees)///////////////////////////////////////////////////////////////////////////
                    ...
                    table_Scene1.setItems(getEmployee());
...
////////////////////////////////////////////New scene 6 (Task manager)/////////////////////////////////////////////////////////////////////////
                    ...
                    table_Scene6.getColumns().addAll(nameColumn_Scene6, dateColumn_Scene6, deadlineColumn_Scene6);
        ...
        EventHandler<ActionEvent> event = new EventHandler<ActionEvent>() {
            public void handle(ActionEvent e)
            {
                ...
                deadlineLabel.setText("Date :" + i);
                    ...
                    //-------------------------------------------------
                    viewAllEmployee_Scene0.setOnAction(e-> Window.setScene(sceneAllEmployees_Scene1));
                    ...
                    saveButton_Scene2.setOnAction(e->{
                        ...
                        empol.setUsername(emailInput_Scene2.getText());
                    ...
                    viewButton_Scene1.setOnAction(e->{
                        ...
                        addressInput_Scene4.setText(empo.getUsername());
                        ...
                        requestedSalaryInput_Scene4.setText((empo.getRaiseRequest()).get(0).getStatus());
                        startVacationInput_Scene4.setText((empo.getVacations().get(0)).getStartDate());
                        endVacationInput_Scene4.setText((empo.getVacations().get(0)).getEndDate());
                        ...
                        currentTaskInput_Scene4.setText(empo.getTasks().get(0).getName());
                    ...
                    saveButton_Scene7.setOnAction(e->{
                        ...
                        try {
                            ...
                            Date doe=Date.from(myLocalDate.atStartOfDay(ZoneId.of( "America/Montreal" )).toInstant());
                            String Ds=new SimpleDateFormat("dd-MM-yyyy").format(doe);
                            to.setCompletionDate(new SimpleDateFormat("dd-MM-yyyy").parse(Ds));
                    ...
                    myPerformance.setOnAction(ev -> Window.setScene(performance));
...
//       System.out.println(emp.getUsername());
    ...
    public void markasCompleted(Employee emp) throws IOException, InterruptedException {
        int t = emp.getTotalCompletedTasks();
        t++;
        emp.setTotalCompletedTasks(t);
...
//        System.out.println(emp.getUsername());
    ...
    public ObservableList<Employee> getEmployee() throws InterruptedException, IOException, ParseException {
